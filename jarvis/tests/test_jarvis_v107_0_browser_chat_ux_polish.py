...
class JarvisV1070BrowserChatUxPolishTests(unittest.TestCase):
    ...
    def test_operator_surface_is_v107_browser_chat_ux_polish(self) -> None:
        ...
        self.assertIn(operator.CURRENT_OPERATOR_SURFACE, {"browser_chat_ux_polish", "assistant_tool_registry", "assistant_data_source_registry", "assistant_asset_lookup", "assistant_market_context", "assistant_news_context"})

        surface = operator.get_active_runtime_surface()
        self.assertTrue(surface["active_runtime_stage"].startswith("v"))
        self.assertIn(surface["current_operator_surface"], {"browser_chat_ux_polish", "assistant_tool_registry", "assistant_data_source_registry", "assistant_asset_lookup", "assistant_market_context", "assistant_news_context"})
