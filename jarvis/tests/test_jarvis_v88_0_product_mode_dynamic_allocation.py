...
class JarvisV880ProductModeDynamicAllocationTests(unittest.TestCase):
    def test_product_mode_uses_v88_status_identity(self) -> None:
        ...
        self.assertTrue("JARVIS_V88_0_PRODUCT_MODE_DYNAMIC_ALLOCATION_READY_SAFE" in source or "JARVIS_V89_0_CRYPTO_CAP_POLICY_READY_SAFE" in source)
        self.assertTrue("JARVIS_V88_0_PRODUCT_MODE_DYNAMIC_ALLOCATION_REVIEW_REQUIRED_SAFE" in source or "JARVIS_V89_0_CRYPTO_CAP_POLICY_REVIEW_REQUIRED_SAFE" in source)
    ...
    def test_operator_surface_is_v88(self) -> None:
        ...
        self.assertIn('ACTIVE_RUNTIME_STAGE = "v89.0"', source)
        self.assertIn('CURRENT_OPERATOR_SURFACE = "crypto_cap_policy_hotfix"', source)
