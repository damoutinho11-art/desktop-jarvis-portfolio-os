...
class JarvisV880ProductModeDynamicAllocationTests(unittest.TestCase):
    def test_product_mode_uses_v88_status_identity(self) -> None:
        ...
        self.assertIn("JARVIS_V88_0_PRODUCT_MODE_DYNAMIC_ALLOCATION_READY_SAFE", source)
        self.assertIn("JARVIS_V88_0_PRODUCT_MODE_DYNAMIC_ALLOCATION_REVIEW_REQUIRED_SAFE", source)
    ...
    def test_operator_surface_is_v88(self) -> None:
        ...
        self.assertIn('ACTIVE_RUNTIME_STAGE = "v88.0"', source)
        self.assertIn('CURRENT_OPERATOR_SURFACE = "product_mode_dynamic_allocation"', source)
