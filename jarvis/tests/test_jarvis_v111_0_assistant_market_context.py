...
class JarvisV1110AssistantMarketContextTests(unittest.TestCase):
    ...
    def test_operator_surface_v111_and_route(self) -> None:
        ...
        self.assertIn(operator.CURRENT_OPERATOR_SURFACE, {"assistant_market_context", "assistant_news_context", "assistant_router", "assistant_answer_style_polish", "assistant_system_audit"})
