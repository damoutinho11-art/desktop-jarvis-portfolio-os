...
from jarvis.jarvis_public_asset_universe_discovery_plan_report import build_report_from_path, main
...
class PublicAssetUniverseDiscoveryPlanReportTests(unittest.TestCase):
    ...
    def test_cli_default_and_input_work_without_subprocess(self) -> None:
        for argv in (
            ["jarvis_public_asset_universe_discovery_plan_report"],
            ["jarvis_public_asset_universe_discovery_plan_report", "--input", SYNTHETIC_COMPLETE],
        ):
    ...
    def test_module_import_is_safe_and_report_writes_no_files(self) -> None:
        module = importlib.import_module("jarvis.jarvis_public_asset_universe_discovery_plan_report")
        ...
        self.assertIn("Public Asset Universe Discovery Plan", report)
