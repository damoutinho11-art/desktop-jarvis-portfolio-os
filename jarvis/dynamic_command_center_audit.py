...
REQUIRED_COMMANDS = (
    ...
    "python -m jarvis.dynamic_market_data_source_quality_gate_report",
...
def audit_dynamic_command_center(
    ...
    chain_statuses = {
        ...
        "source_quality": dashboard.source_quality_status,
    ...
    ready_statuses = {
        ...
        "DYNAMIC_MARKET_DATA_SOURCE_QUALITY_READY_SAFE",
