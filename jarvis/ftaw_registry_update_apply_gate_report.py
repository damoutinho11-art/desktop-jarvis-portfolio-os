"""Readable report for FTAW registry update apply gate."""
...
def build_ftaw_registry_update_apply_gate_report(
    ...
    pack = build_ftaw_registry_update_apply_gate_from_files(
    ...
    lines = [
        "J.A.R.V.I.S. FTAW Registry Update Apply Gate Report",
    ...
    lines.extend(
        [
            ...
            "apply gate readiness is not registry mutation.",
            "apply gate readiness is not asset approval.",
            "apply gate readiness is not verified evidence promotion.",
            "apply gate readiness is not allocation advice.",
            "apply gate readiness is not a buy/sell request.",
            "apply gate readiness is not trade execution.",
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Build FTAW registry update apply gate report.")
    ...
    print(
        build_ftaw_registry_update_apply_gate_report(
